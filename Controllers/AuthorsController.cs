...
namespace MVCBookk.Controllers
{
    ...
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(MVCBookkContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchStringFirstName, string searchStringLastName)
        {
            ...
            {
                authors = authors.Where(a => a.FirstName.Contains(searchStringFirstName));
            }

            if (!string.IsNullOrEmpty(searchStringLastName))
            {
                authors = authors.Where(a => a.LastName.Contains(searchStringLastName));
            }
